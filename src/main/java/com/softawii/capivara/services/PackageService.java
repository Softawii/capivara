...
import com.softawii.capivara.exceptions.PackageAlreadyExistsException;
import com.softawii.capivara.exceptions.PackageDoesNotExistException;
...
public class PackageService {
    ...
    public Package create(Package pkg) throws PackageAlreadyExistsException {
        if (packageRepository.existsById(pkg.getPackageKey()))
    ...
    public void update(Package pkg) throws PackageDoesNotExistException {
        if (!packageRepository.existsById(pkg.getPackageKey()))
            throw new PackageDoesNotExistException("Package does not exist");
